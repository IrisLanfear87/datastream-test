...
export const MIXED_UNITS = "Dataset contains mixed unit values";

export const NO_DATA = "No data available";

// Header content
export const APP_TITLE = "Water Temperature Average Calculator";
export const APP_SUBTITLE =
  "Upload and calculate average water temperature values from various locations";
